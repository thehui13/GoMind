...
import (
	"GoMind/common/aihelper"
	"GoMind/common/code"
	dao "GoMind/dao/session"
	"GoMind/model"
	"context"
	"log"
	"net/http"
...
func GetUserSessionsByUserName(userName string) ([]model.SessionInfo, error) {
	//从数据库获取用户的所有会话
	sessions, err := dao.GetSessionsByUserName(userName)
	if err != nil {
		return nil, err
	}
